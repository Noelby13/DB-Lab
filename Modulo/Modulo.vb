...
Module Modulo
    ...
    Sub verReportePersonalizado(ByVal t As DataTable, ByVal fac As DataTable, ByVal nombreDsResultados As String, nombreDsDatosFactura As String, ByVal nombreRpt As String)
        Try
            Dim rpt As New ReportDataSource(nombreDsResultados, t)
            Dim rpt1 As New ReportDataSource(nombreDsDatosFactura, fac)
